import { ExtendedRequest,IUser,IPost} from "../libs/types";
...
export const getFeed = expressAsyncHandler(async (req:any, res:any) => {
...
export const getPostsByUserId = expressAsyncHandler(async (req:any, res:any) => {
...
export const getRandom = expressAsyncHandler(async (req:any, res) => {
...
export const createPost = expressAsyncHandler(async (req:any, res:any, next: NextFunction) => {
...
export const getPostById = expressAsyncHandler(async (req:any, res:any) => {
  const { id } = req.params;
...
export const deletePostById = expressAsyncHandler(async (req:any, res:any) => {
...
export const ratePostById = expressAsyncHandler(async (req:any, res: Response) => {
