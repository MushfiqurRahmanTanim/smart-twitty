...
export const getTopUsersByFollowers = expressAsyncHandler(async (req:any, res:any) => {
...
export const deleteUserById = expressAsyncHandler(async (req:any, res) => {
...
export const updateUserById = expressAsyncHandler(async (req:any, res:any) => {
  const { id } = req.params;
...
export const toggleFollowUser = expressAsyncHandler(async (req:any, res) => {
...
export const getFollowersById = expressAsyncHandler(async (req:any, res:any) => {
  const { id } = req.params;
...
export const getFollowingsById = expressAsyncHandler(async (req:any, res:any) =>{
  const { id } = req.params;
